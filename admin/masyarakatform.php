...
$tabel          = "masyarakat"; // nama tabel
$index          = "id"; // index / primary key
$fileutama      = "masyarakat.php"; // fil utama dari program kerja
$fileupdate     = "masyarakatform.php"; // file untuk update data
$caption        = "MASYARAKAT"; // caption ack
