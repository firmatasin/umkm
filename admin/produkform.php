...
$fileutama      = "produk.php"; // fil utama dari program kerja
$fileupdate     = "produkform.php"; // file untuk update data
$caption        = "PRODUK"; // caption ack
...
<head>
  ...
  <title>PENGATURAN DATA PRODUK</title>
