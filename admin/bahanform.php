...
$tabel          = "bahan"; // nama tabel
$index          = "id"; // index / primary key
$fileutama      = "bahan.php"; // fil utama dari program kerja
$fileupdate     = "bahanform.php"; // file untuk update data
$caption        = "BAHAN"; // caption ack
...
<head>
  ...
  <title>PENGATURAN DATA BAHAN</title>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Pengaturan Data Bahan</h3>
