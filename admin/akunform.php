...
$tabel          = "akun"; // nama tabel
$index          = "id"; // index / primary key
$fileutama      = "akun.php"; // fil utama dari program kerja
$fileupdate     = "akunform.php"; // file untuk update data
$caption        = "AKUN"; // caption ack
            ...
            <div class="container">
              ...
              <form action="#" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                ...
                <?php make_dynamic_form ( $labelarr, 
                                          $datatype, 
                                          $dataarr,
                                          array("hak_akses"=>array("superadmin","operator")),
                                          array(),
                                          $total, 
                                          $index); ?>
                <!-- From Dinamis: akhir -->
