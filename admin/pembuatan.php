...
<?php 
  $caption    = "PEMBUATAN Baru";
  $fileutama  = "pembuatan.php";
  $dataform  = "pembuatanform.php";
?>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <!-- ISI KONTEN -->
            <!--DATA TABLE-->
            <?php get_data_info("pembuatan", "id", 
                  array("id", "gambar", "produk", "durasi", "tempat"), // tampikan field data
                  $dataform, "id"); ?>
            <!--/*DATA TABLE -->
            <!-- /*ISI KONTEN -->
          </div>
