...
<?php 
  $caption    = "MASYARAKAT Baru";
  $fileutama  = "masyarakat.php";
  $dataform  = "masyarakatform.php";
?>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Pengaturan Data Masyarakat</h3>
          ...
          <div class="card-body">
            <!-- ISI KONTEN -->
            <!--DATA TABLE-->
            <?php get_data_info("masyarakat", "id", 
                  array("id", "gambar", "nama", "alamat"), // tampikan field data
                  $dataform, "id"); ?>
            <!--/*DATA TABLE -->
            <!-- /*ISI KONTEN -->
          </div>
