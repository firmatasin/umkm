...
$tabel          = "ukuran"; // nama tabel
$index          = "id"; // index / primary key
$fileutama      = "ukuran.php"; // fil utama dari program kerja
$fileupdate     = "ukuranform.php"; // file untuk update data
$caption        = "UKURAN"; // caption ack
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Pengaturan Ukuran</h3>
